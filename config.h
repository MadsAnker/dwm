...
static const char *fonts[]          = { 
	"-*-terminux-mediumr-r-normal-*-14-*-*-*-*-*-*-*",
	"FontAwesome:size=14"
};
static const char dmenufont[]       = "-*-terminux-mediumr-r-normal-*-14-*-*-*-*-*-*-*";
...
static const char *updatestatusline[] = {"updatestatus", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,						XK_F3,	   spawn,		   {.v = updatestatusline} },
	{ MODKEY,						XK_F2,	   spawn,		   {.v = updatestatusline} },
	{ MODKEY,						XK_F1,	   spawn,		   {.v = updatestatusline} },
